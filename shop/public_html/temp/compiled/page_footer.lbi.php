...
?>
    ...
    <div class="foot_con">
        ...
        <div id="bottomNav" class="rolling" >
            ...
            <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_96541700_1494491316');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_96541700_1494491316']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?>
            <a href="<?php echo $this->_var['nav_0_96541700_1494491316']['url']; ?>" <?php if ($this->_var['nav_0_96541700_1494491316']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav_0_96541700_1494491316']['name']; ?></a> 
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
            <?php endif; ?>
        </div>
...
?> 
        ...
        <p style="color:#999;">新疆喀什市深喀大道浙商大厦12层01-03室        Tel: 0998-2316977 </p>
        </div>
